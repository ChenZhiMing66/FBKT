...
def get_command_line_parser():
    ...
    parser.add_argument('-dataset', type=str, default='cub200',
                        choices=['mini_imagenet', 'cub200', 'cifar100', 'stanfordcar'])
    ...
    parser.add_argument('-fantasy', type=str, default='rotation2', help='fantasy method to generate virtual classes')
    ...
    parser.add_argument('-alpha', type=float, default=0.5, help='coefficient of the Cluster-aware constraint loss')
    parser.add_argument('-beta', type=float, default=0.5, help='coefficient of the KL loss')
